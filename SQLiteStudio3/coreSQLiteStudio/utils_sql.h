...
//API_EXPORT QString& wrapObjIfNeeded(QString& obj, Dialect dialect, NameWrapper favWrapper = NameWrapper::null);
API_EXPORT QString wrapObjIfNeeded(const QString& obj, Dialect dialect, NameWrapper favWrapper = NameWrapper::null);
//API_EXPORT QString& wrapObjName(QString& obj, Dialect dialect, NameWrapper favWrapper = NameWrapper::null);
...
//API_EXPORT QString& wrapString(QString& str);
API_EXPORT QString wrapString(const QString& str);
//API_EXPORT QString& wrapStringIfNeeded(QString& str);
...
API_EXPORT QList<QString> wrapObjNames(const QList<QString>& objList, Dialect dialect = Dialect::Sqlite3);
...
API_EXPORT QStringList splitQueries(const QString& sql, Dialect dialect);
