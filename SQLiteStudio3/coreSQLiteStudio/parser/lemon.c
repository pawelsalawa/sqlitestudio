/*
 * This is a version of lemon that works with grammar files used by SQLiteStudio.
 * It's taken from one of older SQLite versions. Code from new SQLite codebase is incompatible, unfortunately.
 *
