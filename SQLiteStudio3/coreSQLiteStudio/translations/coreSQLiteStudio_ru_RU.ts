...
Error details: %2</source>
    ...
    <message>
        ...
        <translation>Невозможно инициализировать файл конфигурации. Любые изменения конфигурации, а также история запросов будут утеряны при перезапуске приложения. Невозможно создать файл в следующих расположениях: %1.</translation>
    </message>
    <message>
