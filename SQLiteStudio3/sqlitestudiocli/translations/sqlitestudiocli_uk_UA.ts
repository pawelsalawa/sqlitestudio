...
<TS version="2.1" language="uk" sourcelanguage="en">
  ...
  <context>
    ...
    <message>
      ...
      <translation type="vanished">Закриває зв&apos;язок з базою даних. Якщо база даних вже закрита, нічого не відбувається. Якщо &lt;name&gt; буде передбачено, то назва бази даних має бути закрита (як надруковано командою %1). &lt;name&gt; не передбачено, поточна робоча база даних закрита (детальніше дивіться довідку %2).</translation>
    </message>
    <message>
