...
Допустимые значения: %2</translation>
    ...
    <message>
      ...
      <translation type="vanished">Не удалось открыть указанную базу данных для выполнения файла SQL. Вы можете воспользоваться опцией -d, чтобы узнать больше деталей.</translation>
    </message>
  </context>
</TS>
