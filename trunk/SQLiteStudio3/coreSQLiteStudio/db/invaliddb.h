...
class InvalidDb : public Db
{
    public:
        ...
        SqlResultsPtr exec(const QString& query, const QList<QVariant>& args, Flags flags);
        SqlResultsPtr exec(const QString& query, const QHash<QString, QVariant>& args, Flags flags);
        SqlResultsPtr exec(const QString& query, Db::Flags flags);
